    ...
    return (
        <div className='article-container'>
            ...
            <div className='article-container__content'>
                {
                    data[page - 1].map((data, i) => {
                        return (
                            <div className="slider-container__context-slide" key={i}>
                                <img src={data.image} height={257} />
                                <article className='slider-container__context-slide-text'>
                                    <h1>{data.title}</h1>
                                    <p>{data.body}</p>
            ...
            <div className='page-control'>
                <div className={page === 1 ? 'page-control-btn inactive' : 'page-control-btn'} onClick={decrement}>
                ...
                <div className={page === 2 ? 'page-control-btn inactive' : 'page-control-btn'} onClick={increment}>
                    <div className='svg-container'>
                        <svg width="10" height="16" viewBox="0 0 10 16" fill="none" xmlns="http://www.w3.org/2000/svg">
